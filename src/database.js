/**
 * Adam OS — Local SQLite database
 * Stores all business data locally on your Mac.
 * No Docker, no PostgreSQL, no server needed.
 */
...
db.exec(`
  ...
  -- Seed businesses if not exists
  INSERT OR IGNORE INTO businesses (id, name, type, address) VALUES 
  ...
  -- Seed sample tasks
  INSERT OR IGNORE INTO tasks (id, title, priority, due_date, category, business) VALUES
